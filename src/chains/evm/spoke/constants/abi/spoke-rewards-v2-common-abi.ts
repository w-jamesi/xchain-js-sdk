export const SpokeRewardsV2CommonAbi = [
  {
    inputs: [
  ...
  },
  {
    inputs: [
      ...
      { internalType: "bytes32", name: "accountId", type: "bytes32" },
      {
        ...
        internalType: "struct SpokeRewardsV2Common.PoolEpoch[]",
      ...
      },
      {
        ...
        internalType: "struct SpokeRewardsV2Common.ReceiveRewardToken[]",
        name: "rewardTokensToReceive",
        type: "tuple[]",
      },
    ],
    name: "claimRewards",
