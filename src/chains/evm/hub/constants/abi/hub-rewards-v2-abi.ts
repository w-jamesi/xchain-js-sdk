export const HubRewardsV2Abi = [
  ...
  {
    inputs: [
      { internalType: "uint8", name: "expectedRewardTokenId", type: "uint8" },
      { internalType: "uint8", name: "actualRewardTokenId", type: "uint8" },
    ],
    name: "CannotUpdateIncorrectReward",
    type: "error",
  },
  {
    inputs: [
  ...
  {
    inputs: [{ internalType: "uint8", name: "rewardTokenId", type: "uint8" }],
    name: "PossibleDuplicateReward",
    type: "error",
  },
  ...
  },
  {
    inputs: [
      { internalType: "bytes32", name: "accountId", type: "bytes32" },
      { internalType: "uint8", name: "rewardTokenId", type: "uint8" },
    ],
    name: "accountUnclaimedRewards",
  ...
  },
  {
    inputs: [
      { internalType: "uint8", name: "rewardTokenId", type: "uint8" },
      { internalType: "uint16", name: "chainId", type: "uint16" },
      { internalType: "bytes32", name: "spokeAddress", type: "bytes32" },
    ],
    name: "addRewardToken",
    outputs: [],
    stateMutability: "nonpayable",
  ...
  },
  {
    inputs: [
      { internalType: "bytes32", name: "accountId", type: "bytes32" },
      {
        ...
        internalType: "struct HubRewardsV2.PoolEpoch[]",
  ...
  },
  {
    inputs: [
      ...
      { internalType: "uint8", name: "rewardIndex", type: "uint8" },
      { internalType: "uint8", name: "rewardTokenId", type: "uint8" },
      { internalType: "uint256", name: "totalRewards", type: "uint256" },
    ],
